...
export default function ContextMenu({ onView, onDelete }) {
  return (
    <Menu as="div" className="relative inline-block">
      ...
      >
        <Menu.Items
          as="ul"
          className="p-1 m-0 w-28 origin-left right-0 bg-white z-50 absolute text-xs rounded-md shadow shadow-gray-300"
        >
